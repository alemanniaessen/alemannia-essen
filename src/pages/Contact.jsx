...
export default function Contact() {
  ...
  const handleSubmit = (e) => {
    e.preventDefault();
    // Hier würde später die echte Email-Logik stehen
    setStatus("success");
    ...
    <div className="bg-gray-50 min-h-screen pb-20">
      ...
      <div className="bg-[#001845] py-16 text-center text-white mb-10">
        ...
        <p className="text-blue-200 mt-2 text-lg">
          Schreib uns oder vernetze dich mit uns!
        </p>
      </div>

      <div className="max-w-7xl mx-auto px-4 grid grid-cols-1 lg:grid-cols-2 gap-12">

        {/* 1. LINKES SPALTE: DAS FORMULAR */}
        <div className="bg-white rounded-2xl shadow-xl p-8 md:p-12">
          <h2 className="text-2xl font-bold text-[#001845] mb-6">Schreib uns eine Nachricht</h2>
          ...
          <form onSubmit={handleSubmit} className="space-y-6">
            ...
            <div>
              ...
              <input 
                ...
                className="w-full bg-gray-50 border border-gray-300 rounded-lg px-4 py-3 focus:outline-none focus:border-blue-500 focus:ring-1 focus:ring-blue-500 transition"
            ...
            {/* Email */}
            <div>
              <label className="block text-gray-700 font-bold mb-2">Deine E-Mail</label>
              <input 
                type="email" 
                name="email"
                required
                ...
                onChange={handleChange}
                className="w-full bg-gray-50 border border-gray-300 rounded-lg px-4 py-3 focus:outline-none focus:border-blue-500 transition"
            ...
            {/* Betreff (Dropdown) */}
            <div>
              <label className="block text-gray-700 font-bold mb-2">Worum geht es?</label>
              <select 
                name="betreff"
            ...
            {/* Nachricht */}
            <div>
              <label className="block text-gray-700 font-bold mb-2">Deine Nachricht</label>
              <textarea 
                name="nachricht"
                required
                rows="5"
            ...
            <button 
              type="submit" 
              className="w-full bg-blue-600 hover:bg-blue-700 text-white font-bold py-4 rounded-lg shadow-md hover:shadow-lg transition transform hover:-translate-y-1"
            >
              Nachricht absenden
            </button>
          </form>
        ...
        {/* 2. RECHTE SPALTE: INFOS, SOCIAL & KARTE */}
        <div className="space-y-8">
          
          {/* Info Karten */}
          <div className="bg-white rounded-2xl shadow-lg p-8">
            <h3 className="text-xl font-bold text-[#001845] mb-6 border-b pb-2">Kontaktdaten</h3>
            
            <div className="space-y-6">
              <div className="flex items-start gap-4">
                <div className="bg-blue-100 p-3 rounded-full text-blue-600"><IconMap /></div>
                <div>
                  <p className="font-bold text-gray-800">Sportanlage Alemannia Essen</p>
              ...
              <div className="flex items-start gap-4">
                ...
                <div>
                  ...
                  <a href="mailto:info@alemannia-essen.de" className="text-blue-600 hover:underline">----------------------</a>
                </div>
              </div>
              ...
              <div className="flex items-start gap-4">
                ...
                <div>
                  <p className="font-bold text-gray-800">Telefon (Vereinsheim)</p>
          ...
          {/* --- NEU: SOCIAL MEDIA & WHATSAPP SEKTION --- */}
          <div className="bg-white rounded-2xl shadow-lg p-8">
            <h3 className="text-xl font-bold text-[#001845] mb-6 border-b pb-2">Social Media & Chat</h3>
            <p className="text-gray-600 mb-4 text-sm">Folge uns für Updates oder schreib uns direkt:</p>
            
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
              
              {/* WhatsApp */}
              <a href="-------------------------" target="_blank" rel="noreferrer" 
                 className="flex items-center justify-center gap-2 bg-[#25D366] hover:bg-green-600 text-white py-3 rounded-lg font-bold transition shadow-md hover:-translate-y-1">
                 <IconWhatsApp /> WhatsApp
              </a>

              {/* Instagram */}
              <a href="https://www.instagram.com/alemanniaessen/" target="_blank" rel="noreferrer" 
                 className="flex items-center justify-center gap-2 bg-gradient-to-r from-purple-500 to-pink-500 hover:opacity-90 text-white py-3 rounded-lg font-bold transition shadow-md hover:-translate-y-1">
                 <IconInsta /> Instagram
              </a>

              {/* Facebook */}
              <a href="https://www.facebook.com/AlemanniaEssen2017" target="_blank" rel="noreferrer" 
                 className="flex items-center justify-center gap-2 bg-[#1877F2] hover:bg-blue-700 text-white py-3 rounded-lg font-bold transition shadow-md hover:-translate-y-1">
                 <IconFacebook /> Facebook
              </a>

              {/* TikTok */}
              <a href="----------------------" target="_blank" rel="noreferrer" 
                 className="flex items-center justify-center gap-2 bg-black hover:bg-gray-800 text-white py-3 rounded-lg font-bold transition shadow-md hover:-translate-y-1">
                 <IconTiktok /> TikTok
              </a>
            </div>
          </div>

          {/* Direkt Ansprechpartner (Beibehalten) */}
          <div className="bg-[#001845] rounded-2xl shadow-lg p-8 text-white">
            <h3 className="text-xl font-bold mb-4 border-b border-blue-800 pb-2">Wichtige Ansprechpartner</h3>
            <ul className="space-y-3 text-blue-100">
              <li>
                <span className="font-bold text-white block">Jugendleitung:</span>
                ----------------- (------------------)
              </li>
              <li>
                <span className="font-bold text-white block">Sportliche Leitung:</span>
                ----------------- (-----------------)
              </li>
            </ul>
          </div>

          {/* Google Maps Karte (KORRIGIERT) */}
          <div className="bg-white rounded-2xl shadow-lg overflow-hidden h-64 md:h-80">
            <iframe 
              ...
              frameBorder="0" 
              style={{ border: 0 }} 
              // DIESER LINK IST DER WICHTIGE FIX:
